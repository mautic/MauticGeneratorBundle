...
use Mautic\Bundle\MauticGeneratorBundle\Generator\BundleGenerator;
...
class GenerateBundleCommand extends GeneratorCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
The <info>%command.name%</info> command helps you generates new Mautic bundles.
...
<info>php app/console %command.name% --namespace=Acme/BlogBundle</info>
...
<info>php app/console %command.name% --namespace=Acme/BlogBundle --dir=src [--bundle-name=...] --no-interaction</info>

Note that the bundle namespace must end with "Bundle".
EOT
            )
            ->setName('mautic:generate:bundle')
        ;
    }
